  ...
  "daily_schedule": [
    {
      ...
      "items": [
        {"time": "5:30am ET – 6:30am ET", "event": "Leave for JFK", "type": "travel", "location": "https://maps.google.com/?q=JFK+Airport", "detail": "Allow 1hr for security"},
        {"time": "8:00am ET – 11:30am PT", "event": "DL1234 JFK → LAX", "type": "flight", "location": "https://maps.google.com/?q=LAX+Airport"},
        {"time": "12:00pm PT – 12:45pm PT", "event": "Drive LAX → Irvine", "type": "travel", "detail": "45 min via I-405"},
        {"time": "1:00pm PT – 3:00pm PT", "event": "Anduril Engineering Sync", "type": "meeting", "location": "https://maps.google.com/?q=19800+MacArthur+Blvd+Irvine+CA"},
    ...
    },
    {
      ...
      "items": [
        {"time": "10:00am PT – 12:00pm PT", "event": "Anduril Quarterly Business Review", "type": "meeting", "location": "https://maps.google.com/?q=19800+MacArthur+Blvd+Irvine+CA"},
        {"time": "2:00pm PT – 3:00pm PT", "event": "Arena <> Macnica Meeting", "type": "meeting", "location": "https://zoom.us/j/123456"},
        {"time": "9:00pm PT", "event": "Check in Marriott Irvine", "type": "hotel", "location": "https://maps.google.com/?q=Marriott+Irvine+Spectrum"}
      ]
    },
    {
      ...
      "items": [
        {"time": "3:00pm PT – 3:50pm PT", "event": "Drive to LAX", "type": "travel", "detail": "50 min with rush hour traffic"},
...
- The "time" field MUST include start AND end times in format "8:00am ET – 11:30am PT" (use en-dash). EVERY time must have its own timezone abbreviation (ET, CT, MT, PT, etc) — both the start time AND end time. When crossing time zones, show departure in origin TZ and arrival in destination TZ. When in a single timezone, repeat it on both times (e.g. "1:00pm PT – 3:00pm PT", "5:30am ET – 6:30am ET").
